...
public class Utilisateur implements Serializable {
	...
	public Utilisateur(int noUtilisateur, String pseudo, String nom, String prenom, String email, String telephone,
			String rue, String codePostal, String ville, String motDePasse, int credit, Byte administrateur,List<ArticleVendu> vente,List<ArticleVendu> achat, List<Enchere> encheres) {
		super();
	...
	public Utilisateur(String pseudo, String nom, String prenom, String email, String telephone, String rue,
			String codePostal, String ville, String motDePasse, int credit, Byte administrateur,List<ArticleVendu> vente,List<ArticleVendu> achat, List<Enchere> encheres) {
		super();
		this.pseudo = pseudo;
		this.nom = nom;
		this.prenom = prenom;
	...
	public String toString() {
		return "Utilisateur [noUtilisateur=" + noUtilisateur + ", pseudo=" + pseudo + ", nom=" + nom + ", prenom="
				...
				+ ", administrateur=" + administrateur + ", vente=" + vente + ", achat=" + achat + ", encheres="
				+ encheres + "]";
	}
