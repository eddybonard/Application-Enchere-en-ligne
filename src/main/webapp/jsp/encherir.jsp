...
<body>
	...
	<% 			String article = (String) session.getAttribute("article");
				String description = (String) session.getAttribute("description");
 				...
 				int newPrix = 0;
 				if(session.getAttribute("newPrix") != null){
 					newPrix = (int) session.getAttribute("newPrix");
 				}else{
 					newPrix = 0;
 				}
		...
		<div class="formulaire" style="
			...
			<form method="post" action="ServletAfficherDetailEnchereDeconnecte">
			<div class="retour" style="margin-left: 600px;  "><a href="<%= request.getContextPath() %>/accueil.jsp" > <button type="button" class="btn btn-danger">X</button></a></div>
				...
				<fieldset name="enchere" >
					...
					<div class="container">
							...
							<div class="row">
								<div class="col-lg-12"><label for="offre">Meilleure offre : <%= newPrix %> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-lg-12"><label for="vendeur">Vendeur :  <%= pseudo %>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label></div>
							</div>
							<div class="row">
								<div class="col-lg-12"><label for="proposition">Ma proposition :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </label><input type="number" name="proposition"  min="1" required="required" style="width: 10%;"></div>
							</div>
