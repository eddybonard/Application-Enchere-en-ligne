...
%>
	...
	<%@ include file="jsp/fragment/headerDisconnected.jsp" %>
							...
							<div class="card" style="width: 18em;">
								<img alt="photo de l'Article" src="<%= request.getContextPath() %>/img//photo.jfif">
									<div class="card-body">
										...
										<p>Vendeur : <%= pseudo %></p>
										<a href="<%= request.getContextPath() %>/jsp/ServletAfficherDetailEnchereDeconnecte"><button class="btn btn-info" type="button"  >Détails</button></a>
									</div>
								</div>
							</div>
							<div class="col-lg-4" style="margin-top: 10px; ">
	...
	<%@ include file="jsp/fragment/piedDePage.html" %>
